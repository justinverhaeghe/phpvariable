...
<head>
    ...
    <title>PHP Variables - Exercice 7</title>
</head>
<!-- Header -->
...
<body>
    ...
    <main>
        ...
        <div class="d-flex justify-content-center pt-5">
            <p>Consigne : Créer trois variables lastname , firstname et age et les initialiser avec les valeurs de votre
                choix.
        ...
        <div class="d-flex justify-content-center ">
            ...
            ?>
            <br>
            <?= "Hello, je m'appelle $firstname $lastname, j'ai actuellement $age ans"; ?>
        </div>
